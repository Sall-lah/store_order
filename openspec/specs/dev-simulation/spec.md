# Dev Simulation Mode Specification

## Purpose
Enables offline developer testing of complete order and payment lifecycles when DEV="TRUE" without requiring live Midtrans accounts or ngrok webhook tunnels.
